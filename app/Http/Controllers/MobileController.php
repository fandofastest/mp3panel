...
class MobileController extends Controller
{
    ...
    public function getAllAlbum()
    {
        ...
        $baseapiurl=asset('storage/');
        $album['album'] = Album::select('id','name',DB::raw('CONCAT("'.$baseapiurl.'/album/",cover) as cover'),'deskripsi')
        ->get();
